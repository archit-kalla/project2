...
int *
write_1(Article_t Article, int Nr, int Nw,  CLIENT *clnt)
{
...
void initialize(char *_server_ip, int _server_port, char *_mode) {
...
Page_t *
read_1_svc(int Page_num,  struct svc_req *rqstp)
{	
...
int *
write_1_svc(Article_t Article, int Nr, int Nw,  struct svc_req *rqstp)
{	
