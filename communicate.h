...
#define Read 2
extern  Page_t * read_1(int , int , CLIENT *);
extern  Page_t * read_1_svc(int , int , struct svc_req *);
#define Get_mode 3
...
#define Write 5
extern  int * write_1(Article_t , int , char *, char *, CLIENT *);
extern  int * write_1_svc(Article_t , int , char *, char *, struct svc_req *);
#define Get_seqnum 6
